...
namespace ADAPT.UI
{
    ...
    public class ADAPT_UI_ActionTree : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            /******RELOAD RESOURCES*******/
            node_sprite_action = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Yago Mira/A.D.A.P.T. AI/Editor/Resources/Node_Blue.png");
            node_sprite_action_toGoal = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Yago Mira/A.D.A.P.T. AI/Editor/Resources/Node_Green.png");
            node_sprite_goal = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Yago Mira/A.D.A.P.T. AI/Editor/Resources/Node_Red.png");
