...
{ 
    public class ADAPT_UI_Agents : EditorWindow
    {
        ...
        string custom_scripts_path = "Assets/Yago Mira/A.D.A.P.T. AI/Scripts/Custom/"; //DON'T CHANGE!!!
        ...
        public void InitializeFiles(VisualElement root)
        {
            ...
            // Import UXML
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Yago Mira/A.D.A.P.T. AI/Editor/ADAPT_UI_Agents.uxml");
            VisualElement uxmlRoot = visualTree.CloneTree();
            root.Add(uxmlRoot);

            // A stylesheet can be added to a VisualElement.
            // The style will be applied to the VisualElement and all of its children.
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Yago Mira/A.D.A.P.T. AI/Editor/ADAPT_UI_Agents.uss");
