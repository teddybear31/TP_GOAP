...
namespace ADAPT.UI
{
    public class ADAPT_UI_Predefined : EditorWindow
    {
        ...
        static string predefined_scripts_path = "Assets/Yago Mira/A.D.A.P.T. AI/Scripts/Custom/Predefined"; //DON'T CHANGE!!!
        ...
        public void InitializeFiles(VisualElement root)
        {
            ...
            // Import UXML
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Yago Mira/A.D.A.P.T. AI/Editor/ADAPT_UI_Predefined.uxml");
            VisualElement uxmlRoot = visualTree.CloneTree();
            root.Add(uxmlRoot);

            // A stylesheet can be added to a VisualElement.
            // The style will be applied to the VisualElement and all of its children.
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Yago Mira/A.D.A.P.T. AI/Editor/ADAPT_UI_Predefined.uss");
