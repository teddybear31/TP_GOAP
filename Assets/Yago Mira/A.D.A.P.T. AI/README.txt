...
You will find two demos in the "DEMO" folder:
  ...
  -Demo: it is a classic example of GOAP where there are 3 agents interacting with each other. 
    ...
    *ATENTION: In the Unity Asset store the 3D Models have been replaced by capsules, you can check the Github repository or add your own ones to test the animations properties.
